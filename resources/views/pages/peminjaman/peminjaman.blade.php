        ...
        <div class="container-fluid">
        	<div class="table-responsive table--no-card m-b-30">
		        <table class="table table-borderless table-striped table-earning">
		        	<a href="{{ route('peminjaman.ViewCreate')}}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i></a>
		            <thead>
		                <tr>
		                    ...
		                    <th class="col-lg-3">Tanggal Peminjaman</th>
		                    <th class="col-lg-3">Tanggal Pengembalian</th>
